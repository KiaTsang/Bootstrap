...
<body>
    <input id="query-Type" type="hidden" value="system">
    ...
    <div id="main" role="main">
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
                <h1 class="page-title txt-color-blueDark"><i class="fa-fw fa fa-home"></i> 缺陷综合信息 - 系统产品</h1>
            </div>
            ...
            <div class="col-md-3 col-sm-6 ui-sortable">
                <div class="widget widget-state bg-purple">
                    ...
                    <div class="state-link">
                        <a href="<s:url value="/issue/issues_list_syspro.jspa?searchKey=status&searchValue=NEW"/>" data-item-index="5">查看信息 <i class="fa fa-arrow-circle-o-right"></i></a>
                    </div>
                </div>
            </div>
            <div class="col-md-3 col-sm-6 ui-sortable">
                <div class="widget widget-state bg-red">
                    ...
                    <div class="state-link">
                        <a href="<s:url value="/issue/issues_list_syspro.jspa?searchKey=priority&searchValue=CRITICAL"/>" data-item-index="5">查看信息 <i class="fa fa-arrow-circle-o-right"></i></a>
                    </div>
                </div>
            </div>
            <div class="col-md-3 col-sm-6 ui-sortable">
                <div class="widget widget-state bg-blue">
                    ...
                    <div class="state-link">
                        <a href="<s:url value="/issue/issues_list_syspro.jspa?searchKey=status&searchValue=OPEN,REOPEN"/>" data-item-index="5">查看信息 <i class="fa fa-arrow-circle-o-right"></i></a>
                    </div>
                </div>
            </div>
            <div class="col-md-3 col-sm-6 ui-sortable">
                <div class="widget widget-state bg-green">
                    ...
                    <div class="state-link">
                        <a href="<s:url value="/issue/issues_list_syspro.jspa?searchKey=status&searchValue=VALIDATED,CLOSED"/>" data-item-index="5">查看信息 <i class="fa fa-arrow-circle-o-right"></i></a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <section id="widget-grid">
                    ...
                    <div class="jarviswidget" id="wid-id-0" data-widget-editbutton="false" data-widget-colorbutton="false" data-widget-deletebutton="false" data-widget-fullscreenbutton="false">
                        <header>
                            ...
                            <ul class="nav nav-tabs pull-left in" id="myTab">
                                <li class="active">
                                    <a id="myTabS1" data-toggle="tab" href="#s1"><i class="fa fa-bar-chart-o"></i>
                                        <span class="hidden-mobile hidden-tablet">反馈数量统计</span>
                                    </a>
                                </li>

                                <li>
                                    <a id="myTabS2" data-toggle="tab" href="#s2"><i class="fa fa-bar-chart-o"></i>
                                        <span class="hidden-mobile hidden-tablet">严重程度统计</span>
                                    </a>
                                </li>

                                <li>
                                    <a id="myTabS3" data-toggle="tab" href="#s3"><i class="fa fa-bar-chart-o "></i>
                                        <span class="hidden-mobile hidden-tablet">缺陷来源统计</span>
                                    </a>
                                </li>
                            </ul>
                                ...
                                <div id="myTabContent" class="tab-content">
                                    ...
                                    <div class="tab-pane fade padding-10 no-padding-bottom" id="s2">
                                        <div style="margin-bottom: 24px;">
                                            <p class="graph-title"></p>
                                            <span class="chart2-legend pull-right"></span>
                                           </div>
                                        <div id="chart2" class="chart-large has-legend-unique"></div>
                                    </div>
                                    <!-- end s2 tab panel -->
                                    ...
                                    <div class="tab-pane fade padding-10 no-padding-bottom" id="s3">
                                        <div style="margin-bottom: 24px;">
                                            <p class="graph-title"></p>
                                            <span class="chart3-legend pull-right"></span>
                                        </div>
                                        <div id="chart3" class="chart-large has-legend-unique"></div>
                                    </div>
                                    <!-- end s3 tab pane -->
                                </div>
            ...
            <div class="row">
                ...
                <article id="taskArticle4" class="col-sm-6 col-md-6 col-lg-6">
                    <div class="jarviswidget jarviswidget-color-blue" id="wid-id-4" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-deletebutton="false">
                        ...
                        <!-- widget div-->
                           <div>
                            ...
                            <div class="widget-body no-padding">
                                <table id="dt_production_project" class="table table-striped table-hover compact fixedTable dt-responsive no-wrap">
                                    <thead>
                                        <tr>
                                            <th>名称</th>
                                            <th class="text-align-center">总数量</th>
                                            <th class="text-align-center">已解决</th>
                                            <th class="text-align-center">所占比例</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                    </tbody>
...
<script>
    ...
    function generatePageGraphs() {
        ...
        loadScript('<s:url value="/js/core/report/system/reportMainPageSystemStatistics.js" />', function() {
