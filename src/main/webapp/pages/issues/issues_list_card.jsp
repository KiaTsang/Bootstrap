...
<style>
    ...
    /*#dt_issues > thead > tr > th:last-child, #dt_issues > tbody > tr > td:last-child {
        	                                ...
        	                                <div class="input-group">
        	                                    <div class="input-group-btn">
                                                    ...
                                                    <ul id="issue-condition-selector" class="dropdown-menu">
                                                        ...
                                                        <li class="divider"></li>
                                                        <li>
                                                            <a href="javascript:;" data-last-value="projectName"><s:text name="project.name"/></a>
                                                        </li>
                                                        <li>
                                                        ...
                                                        <!--
                                                        <li>
                                                            <a href="javascript:;" data-last-value="receiver"><s:text name="issue.reciever"/></a>
                                                        </li>
                                                         -->
                                                        <li>
    		...
    		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        		<div class="well">
            		<div class="widget-body-toolbar" style="padding:1px 13px 10px 0;">
            		    <a href='<s:url value="/issue/issues_new_card.jspa" />' class="btn btn-success btn-sm pull-right" >
            		        <i class="fa fa-lg fa-plus"></i> <span class="hidden-mobile hidden-tablet"><s:text name="issue.create"/></span>
                        </a>
        		        <%-- 导出按钮 --%>                                            
...
<script type="text/javascript">
    ...
    function loadDataTableScripts() {
        ...
        function dt_4() {
            loadScript("<s:url value='/js/plugin/datatables10/dataTables.colVis.min.js'/>", dt_5);
        }
        ...
        function inittable() {
            loadScript("<s:url value='/js/core/issues/issuesCard.js'/>", init);
        }
    }
