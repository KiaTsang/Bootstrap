...
.table thead tr, .fc-border-separate thead tr {
    ...
    background-image: -moz-linear-gradient(ceanter top , #FFFFFF 0px, #FFFFFF 100%);
    font-size: 12px;
}
.toolbar > a {
...
<body>
    ...
    <div id="main" role="main">
        <div id="ribbon">
            <!-- breadcrumb -->
            <ol class="breadcrumb">
                <li><a href="<s:url value="/dashboard_syspro.jspa"/>" data-item-index="2">系统产品首页</a></li>
                <li><a href="<s:url value="/issue/issues_list_syspro.jspa"/>" data-item-index="5">缺陷列表</a></li>
                <li>详情</li>
            </ol>
            <!-- end breadcrumb -->
        </div>
                                ...
                                <div class="widget-body">
                                    <div class="row">
                                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                            ...
                                            <%-- <br>
                                            <span class="font-lg">项目名称：</span><span class="font-lg pjTitle break-all">
                                                <s:property value="issueDTO.projectDTO.name" default="---"/>
                                            </span> --%>
                                            <div>
                                                ...
                                                <div class="inline pull-left w-600">
                                                    <span class="font-lg pjTitle break-all title-link">
                                                        <s:property value="issueDTO.projectDTO.name" default="---"/>
                                                    </span>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                                            <ul class="list-unstyled">
                                                                 <li>
                                                                    <p>
                                                                        <span class="text-muted details-label nf"><s:text name="issue.product.owner"/><s:text name="punctuation.colon"/></span>
                                                                        <s:property value="issueDTO.productionDTO.productionManagerDTO.realName" default="---"/> <s:if test="issueDTO.productionDTO.productionManager!=NULL">[ <s:property value="issueDTO.productionDTO.productionManager"/> ]</s:if>
                                                                    </p>
                                                                </li>
                                                                 <li >
                                                                    <p>
                                                                        <span class="text-muted details-label nf"><s:text name="project.manager"/><s:text name="punctuation.colon"/></span>
                                                                        <s:property value="issueDTO.projectDTO.projectManagerDTO.realName" default="---"/> <s:if test="issueDTO.projectDTO.projectManager!=NULL">[ <s:property value="issueDTO.projectDTO.projectManager"/> ]</s:if>
                                                                    </p>
                                                                </li>
                                                                <li >
                                                                    <p>
                                                                        <span class="text-muted details-label nf"> <s:text name="issue.system.name"/><s:text name="punctuation.colon"/></span>
                                                                        <span class="proName"><s:property value="issueDTO.productionDTO.productionName" default="---"/></span>
                                                                    </p>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                                            <ul class="list-unstyled">
                                                                <li>
                                                                    <p class="text-muted">
                                                                        <span class="details-label"><s:text name="issue.module"/><s:text name="punctuation.colon"/></span>
                                                                        <s:set var="module" value="issueDTO.module"/>
                                                                        <a class="break-all" href="javascript:void(0);" id="module" data-name="module" data-type="text" data-pk="${issueId}" data-value="${module }" data-max-length="200">
                                                                            <s:property value="#module" default="---"/>
                                                                        </a>
                                                                    </p>
                                                                </li>
                                                            </ul>
                                                            ...
                                                            <ul class="list-unstyled">
                                                                <li>
                                                                    ...
                                                                    <p class="text-muted">
                                                                        ...
                                                                        <s:else>
                                                                            <span class="bp"><s:property value="issueDTO.basicPoint" default="---"/></span>
                                                                        </s:else>
                                                                    </p>
                                                                </li>
                                                            </ul>
                                                            ...
                                                            <ul class="list-unstyled">
                                                                ...
                                                                <li >
                                                                    <p class="text-muted">
                                                                        ...
                                                                        <a href="javascript:void(0);" id="priority" data-name="priority" data-type="select2" data-pk="${issueId}" data-select-search="true" data-value="${issueDTO.priority }" data-original-title="选择优先级"><s:text name="issue.priority.%{issueDTO.priority}" /></a>
                                                                    </p>
                                                                </li>
                                                                <li >
                                                                    <p class="text-muted">
                                                            ...
                                                            <ul class="list-unstyled">
                                                                ...
                                                                <li >
                                                                    <p class="text-muted">
                                                                        ...
                                                                        <a href="javascript:void(0);" id="securityLevel" data-name="securityLevel" data-type="select2" data-pk="${issueId}" data-select-search="true" data-value="${issueDTO.securityLevel }" data-original-title="">
                                                                ...
                                                                <li >
                                                                    <p class="text-muted">
                                                                        ...
                                                                        <a href="javascript:void(0);" id="fixVersion" data-name="fixedVersion" data-type="text" data-pk="${issueId}" data-select-search="true" data-value="${fixVersion }" data-max-length="30">
                                                            ...
                                                            <ul class="list-unstyled">
                                                                <li >
                                                                    <p class="text-muted">
                                                                        ...
                                                                        <s:else>
                                                                           <a href="javascript:void(0);" id="dueDate" data-name="dueDate" data-type="combodate" data-viewformat="<s:text name="combodate.date.MMDDYYYYformat"/>" data-format="<s:text name="combodate.date.MMDDYYYYformat"/>" data-template="<s:text name="combodate.date.MMDDYYYYformatU"/>" data-value="${issueDTO.dueDate}" data-pk="${issueId}" data-original-title="<s:text name="issue.chose.deadline"/>">
                                                                            <!-- 2014年 5月10日 10:00 -->
                                            ...
                                            <div class="row widget-hide-overflow">
                                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                                    ...
                                                    <s:if test="#issueStatus != 'CLOSED' && #issueStatus != 'VALIDATED'">
                                                        <div id="ad-container-SystemPro" class="ad-container hidden-xs border-bottom-fixed">
                                                            <span id="chat-list-open-close-SystemPro" class="chat-list-open-close">
    ...
    <input id="viewUrl" type="hidden" value="<s:url value="issue/viewIssueOfSystem.jspa"/>">
    <input id="labelUrl" type="hidden" value="<s:url value="/issue/findDefaultLabelsForSystem.jspa"/>">
    <input id="listUrl" type="hidden" value="<s:url value="/issue/issues_list_syspro.jspa"/>">
    <input id="cloneableProjectType" type="hidden" value="system">
</div>
  ...
  <script type="text/javascript">
        ...
        function initEditable($container, data, callback) {
            ...
            select2Setting = $.extend(select2Setting, //@TODO  状态值需要抽离
                ...
                }}:{}, $container.data("name") === "projectDTO.projectManager" ? {select2 : {
                            allowClear: true,
                            width: 200,
                            ajax: {
    ...
    loadScript('<s:url value="/js/plugin/jquery-file/jquery.fileupload.js" />', loadDataTableScripts);
        ...
        loadScript('<s:url value="/js/core/issues/editSystem.js" />', function() {
