...
<body>
    ...
    <div id="main" role="main">
        <div id="ribbon">
            <!-- breadcrumb -->
            <ol class="breadcrumb">
                <li><a href="<s:url value="/dashboard_cardpro.jspa"/>" data-item-index="1">卡产品首页</a></li>
                <li><a href="<s:url value="/issue/issues_list_card.jspa"/>" data-item-index="4">缺陷列表</a></li>
                <li>详情</li>
            </ol>
            <!-- end breadcrumb -->
        </div>
                            ...
                            <div>
                                ...
                                <div class="widget-body">
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 toolbar">
                                            ...
                                            <div class="btn-group">
                                                ...
                                                <ul class="dtable dropdown-menu pull-right">
                                                    <li>
                                                        <a id="btn-add-attachment" href="javascript:;"><s:text name="issue.attachment.add"/></a>
                                                    </li>
                                                    <li class="divider"></li>
                                                    <li>
                                    ...
                                    <div class="row">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                                            <ul class="list-unstyled">
                                                                <li >
                                                                    <p class="text-muted">
                                                                        <span class="details-label"> <s:text name="project.level"/><s:text name="punctuation.colon"/></span>
                                                                        <a href="javascript:;" id="projectLevel" data-name="projectDTO.projectLevel" data-type="select2" data-pk="${issueId}" data-select-search="true" data-value="${issueDTO.projectDTO.projectLevel }" data-original-title="选择项目级别"><s:text name="issue.projectLevel.%{issueDTO.projectDTO.projectLevel}" /></a>
                                                                    </p>
                                                                </li>
                                                                <li>
                                                                    <p class="text-muted">
                                                                        <span class="details-label">  <s:text name="project.chip.type"/><s:text name="punctuation.colon"/></span>
                                                                        <s:set var="icModel" value="issueDTO.projectDTO.icModel" />
                                                                        <a class="break-all" href="javascript:;" id="icModel" data-name="projectDTO.icModel" data-type="text" data-pk="${issueId}" data-select-search="true" data-value="${icModel}" data-max-length="200">
                                                                            <s:property value="#icModel" default="---" />
                                                                        </a>
                                                                    </p>
                                                                </li>
                                                                ...
                                                                <li>
                                                                    <p class="text-muted">
                                                                        <span class="details-label"> <s:text name="project.productionProcedure"/><s:text name="punctuation.colon"/></span>
                                                                        <s:set var="productionProcedure" value="issueDTO.projectDTO.productionProcedure" />
                                                                        <a class="break-all" href="javascript:;" id="productionProcedure" data-name="projectDTO.productionProcedure" data-type="text" data-pk="${issueId}" data-select-search="true" data-value="${productionProcedure}" data-max-length="200">
                                                                            <s:property value="#productionProcedure" default="---" />
                                                                        </a>
                                                                    </p>
                                                                </li>
                                                                <li>
                                                                    <p class="text-muted">
                                                                        <span class="details-label"> <s:text name="project.productionEquipment"/><s:text name="punctuation.colon"/></span>
                                                                        <s:set var="productionEquipment" value="issueDTO.projectDTO.productionEquipment" />
                                                                        <a class="break-all" href="javascript:;" id="productionEquipment" data-name="projectDTO.productionEquipment" data-type="text" data-pk="${issueId}" data-select-search="true" data-value="${productionEquipment}" data-max-length="200">
                                                                            <s:property value="#productionEquipment" default="---" />
                                                                        </a>
                                                                    </p>
                                                                </li>
                                                                 <li>
                                                                    <p class="text-muted">
                                                                        <span class="details-label"><s:text name="project.app.developer"/><s:text name="punctuation.colon"/></span>
                                                                        <s:set var="appDeveloper" value="issueDTO.projectDTO.appDeveloper" />
                                                                        <a class="break-all" href="javascript:;" id="appDeveloper" data-name="projectDTO.appDeveloper" data-type="text" data-pk="${issueId}" data-select-search="true" data-value="${appDeveloper}" data-max-length="200">
                                                                            <s:property value="#appDeveloper" default="---" />
                                                                        </a>
                                                                    </p>
                                                                </li>
                                                                ...
                                                                <li>
                                                                    <p class="text-muted">
                                                                        <span class="details-label"> <s:text name="project.tester"/><s:text name="punctuation.colon"/></span>
                                                                        <s:set var="tester" value="issueDTO.projectDTO.tester" />
                                                                        <a class="break-all" href="javascript:;" id="tester" data-name="projectDTO.tester" data-type="text" data-pk="${issueId}" data-select-search="true" data-value="${tester}" data-max-length="200">
                                                                            <s:property value="#tester" default="---" />
                                                                        </a>
                                                                    </p>
                                                                </li>
                                                            </ul>
                                                            ...
                                                            <ul class="list-unstyled">
                                                                  <li>
                                                                    <p class="text-muted">
                                                                        ...
                                                                        <a class="break-all" href="javascript:;" id="cProjectType" data-name="projectDTO.projectType" data-type="select2" data-pk="${issueId}" data-select-search="true" data-value="${issueDTO.projectDTO.projectType}" data-original-title="选择项目类型" data-max-length="200"><s:text name="issue.projectType.%{issueDTO.projectDTO.projectType}" /></a>
                                                                    </p>
                                                                </li>
                                                                 <li>
                                                                    <p class="text-muted">
                                                                        <span class="details-label"><s:text name="project.requirementCode"/><s:text name="punctuation.colon"/></span>
                                                                        <s:set var="requirementCode" value="issueDTO.projectDTO.requirementCode" />
                                                                        <a class="break-all" href="javascript:;" id="requirementCode" data-name="projectDTO.requirementCode" data-type="text" data-pk="${issueId}" data-select-search="true" data-value="${requirementCode}" data-max-length="200">
                                                                            <s:property value="#requirementCode" default="---" />
                                                                        </a>
                                                                    </p>
                                                                </li>
                                                                 <li>
                                                                    <p class="text-muted">
                                                                        <span class="details-label"><s:text name="project.cos.version"/><s:text name="punctuation.colon"/></span>
                                                                        <s:set var="cosVersion" value="issueDTO.projectDTO.cosVersion" />
                                                                        <a class="break-all" href="javascript:;" id="cosVersion" data-name="projectDTO.cosVersion" data-type="text" data-pk="${issueId}" data-select-search="true" data-value="${cosVersion}" data-max-length="30">
                                                                            <s:property value="#cosVersion" default="---" />
                                                                        </a>
                                                                    </p>
                                                                </li>
                                                                <li>
                                                                    <p class="text-muted">
                                                                        <span class="details-label"><s:text name="project.cos.developer"/><s:text name="punctuation.colon"/></span>
                                                                        <s:set var="cosDeveloper" value="issueDTO.projectDTO.cosDeveloper" />
                                                                        <a class="break-all" href="javascript:;" id="cosDeveloper" data-name="projectDTO.cosDeveloper" data-type="text" data-pk="${issueId}" data-select-search="true" data-value="${cosDeveloper}" data-max-length="200">
                                                                            <s:property value="#cosDeveloper" default="---" />
                                                                        </a>
                                                                    </p>
                                                                </li>
                                                                <li>
                                                                    <p class="text-muted">
                                                                        <span class="details-label"><s:text name="project.customDeveloper"/><s:text name="punctuation.colon"/></span>
                                                                        <s:set var="customDeveloper" value="issueDTO.projectDTO.customDeveloper" />
                                                                        <a class="break-all" href="javascript:;" id="customDeveloper" data-name="projectDTO.customDeveloper" data-type="text" data-pk="${issueId}" data-select-search="true" data-value="${customDeveloper}" data-max-length="200">
                                                                            <s:property value="#customDeveloper" default="---" />
                                                                        </a>
                                                                    </p>
                                                                </li>
                                                                 <li>
                                                                    <p class="text-muted">
                                                                        <span class="details-label"><s:text name="project.usecase.designer"/><s:text name="punctuation.colon"/></span>
                                                                        <s:set var="ucDesigner" value="issueDTO.projectDTO.ucDesigner" />
                                                                        <a class="break-all" href="javascript:;" id="ucDesigner" data-name="projectDTO.ucDesigner" data-type="text" data-pk="${issueId}" data-select-search="true" data-value="${ucDesigner}" data-max-length="200">
                                                                            <s:property value="#ucDesigner" default="---" />
                                                                        </a>
                                                                    </p>
                                                                </li>
                                                            </ul>
                                                    ...
                                                    <ul class="list-unstyled">
                                                        <li>
                                                            <p class="text-muted">
                                                                ...
                                                                <a class="break-all" href="javascript:;" id="summary" data-type="textarea" data-pk="${issueId}" data-rows="5" data-max-length="200"> ${issueDTO.summary}</a>
                                                            </p>
                                                        </li>
                                                    </ul>
                                                </div>
                                                            ...
                                                            <ul class="list-unstyled">
                                                                <li>
                                                                    <p class="text-muted">
                                                                        ...
                                                                        <a href="javascript:;" id="severity" data-pk="${issueId}" data-name="severity" data-type="select2" data-select-search="true" data-value="${issueDTO.severity }" data-original-title="<s:text name="issue.level"/>">
                                                                ...
                                                                <li >
                                                                    <p class="text-muted">
                                                                        ...
                                                                        <a href="javascript:;" id="priority" data-name="priority" data-type="select2" data-pk="${issueId}" data-select-search="true" data-value="${issueDTO.priority }" data-original-title="<s:text name="issue.priority"/>"><s:text name="issue.priority.%{issueDTO.priority}" /></a>
                                                                    </p>
                                                                </li>
                                                                <li>
                                                                    <p class="text-muted">
                                                                        ...
                                                                        <a class="break-all" href="javascript:;" id="affectsVersion" data-name="affectedVersion" data-type="text" data-pk="${issueId}" data-value="${affectsVersion }" data-max-length="30">
                                                                ...
                                                                <li>
                                                                    ...
                                                                    <p class="text-muted">
                                                                        ...
                                                                        <s:if test="#isManager">
                                                                            <a class="bp" href="javascript:;" data-type="text" data-name="basicPoint" data-value="${issueDTO.basicPoint}" data-pk="${issueId}" data-max-length="30"></a>
                                                                        </s:if>
                                                                        <s:else>
                                                            ...
                                                            <ul class="list-unstyled">
                                                                ...
                                                                <li >
                                                                    <p class="text-muted">
                                                                        ...
                                                                        <a href="javascript:;" id="securityLevel" data-security="true" data-name="securityLevel" data-type="select2" data-pk="${issueId}" data-select-search="true" data-value="${issueDTO.securityLevel }" data-original-title="">
                                                                ...
                                                                <li >
                                                                    <p class="text-muted">
                                                                        ...
                                                                        <a class="break-all" href="javascript:;" id="fixVersion" data-name="fixedVersion" data-type="text" data-pk="${issueId}" data-value="${fixVersion }" data-max-length="30">
                                                    ...
                                                    <ul class="list-unstyled">
                                                        <li>
                                                            <p class="text-muted">
                                                                ...
                                                                <a class="break-all" href="javascript:;" id="environment" data-type="textarea" data-pk="${issueId}" data-rows="4" data-max-length="2048"> ${issueDTO.environment}</a>
                                                            </p>
                                                        </li>
                                                    </ul>
                                                </div>
                                                    ...
                                                    <ul class="list-unstyled">
                                                        <li>
                                                            <p class="text-muted">
                                                                ...
                                                                <a class="break-all" href="javascript:;" id="position" data-type="textarea" data-pk="${issueId}" data-rows="4" data-max-length="2048"> ${issueDTO.position}</a>
                                                            </p>
                                                        </li>
                                                    </ul>
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                                    ...
                                                    <div class="pull-right" style="margin: 10px -20px;">
                                                        <a class="btn btn-default btn-sm btn-edit-issue-desc" href="javascript:;"><i class="fa fa-edit"></i> 编辑</a>
                                                    </div>
                                                ...
                                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 ">
                                                    <div class="padding-10">
                                                        ...
                                                        <div class="tab-content padding-top-10">
                                                            ...
                                                            <!--operation history place container-->
                                                                          ...
                                                                          <ul>
                                                                            <li class="message">
                                                                                ...
                                                                                <span class="message-text break-all">
                                                                                    <a href="javascript:;" class="username">${comment.creator }

                                                                                    </a>${comment.commentBody }
                                                                                    </span>
                                                                                <ul class="list-inline font-xs" style="margin-top: 5px;">
                                                                                    <li>
                                                                                        <a href="javascript:;" class="text-danger action-delete" data-comment="${comment.issueCommentId }"><s:text name="global.delete"/></a>
                                                                                    </li>
                                                                                </ul>
                                                                            </li>
                                                                            <div class="sub-message-replay">
                                                                              <s:iterator value="#comment.subCommentsDTO" var="subComment">
                                                                                <li class="message message-reply">
                                                                                    ...
                                                                                    <span class="message-text break-all"> <a href="javascript:;" class="username">${subComment.creator }</a> ${subComment.commentBody } </span>
                                                                                </li>
                                                                             </s:iterator>
                                                                         </div>
                                                                            <li>
                                        ...
                                        <!--right zone-->
                                        <div class="col-xs-12 col-sm-12 col-md-5 col-lg-5 widgetbody widget-body">
                                            <!--row-->
                                            <div class="row">
                                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 ">
                                                    <span class="timeline-seperator">
                                                                ...
                                                                <li >
                                                                    <p class="text-muted">
                                                                        ...
                                                                        <s:if test="issueDTO.dueDate == null">
                                                                          <a href="javascript:;" id="dueDate" data-name="dueDate" data-type="combodate" data-viewformat="<s:text name="combodate.date.MMDDYYYYformat"/>" data-format="<s:text name="combodate.date.MMDDYYYYformatU"/>" data-template="<s:text name="combodate.date.MMDDYYYYformat"/>" data-value="" data-pk="${issueId}">&nbsp;</a>
                                                                        </s:if>
                                                                        <s:else>
                                                                           <a href="javascript:;" id="dueDate" data-name="dueDate" data-type="combodate" data-viewformat="<s:text name="combodate.date.MMDDYYYYformat"/>" data-format="<s:text name="combodate.date.MMDDYYYYformatU"/>" data-template="<s:text name="combodate.date.MMDDYYYYformat"/>" data-value="${issueDTO.dueDate}" data-pk="${issueId}" data-original-title="<s:text name="issue.chose.deadline"/>">
                                                                            <!-- 2014年 5月10日 10:00 -->
                                            ...
                                            <div class="row widget-hide-overflow">
                                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                                    ...
                                                    <s:if test="#issueStatus != 'CLOSED' && #issueStatus != 'VALIDATED'">
                                                        <div id="ad-container-CardPro" class="ad-container hidden-xs border-bottom-fixed">
                                                            <span id="chat-list-open-close-CardPro" class="chat-list-open-close">
                                                              <i class="fa fa-tag txt-color-blue"></i>
                                                            </span>
                                                            <div id="chat-list-body-CardPro" class="chat-list-body custom-scroll">
    ...
    <input id="projectId" type="hidden" value="${issueDTO.projectDTO.projectId}">
    ...
    <input id="viewUrl" type="hidden" value="<s:url value="issue/viewIssueOfCard.jspa"/>">
    <input id="labelUrl" type="hidden" value="<s:url value="/issue/findDefaultLabelsForCard.jspa"/>">
    <input id="listUrl" type="hidden" value="<s:url value="/issue/issues_list_card.jspa"/>">
    <input id="cloneableProjectType" type="hidden" value="card">
    <input id="isReadOnly" type="hidden" value="${issueDTO.infoReadOnly }">
</div>
  ...
  <script type="text/javascript">
        ...
        // DO NOT REMOVE : GLOBAL FUNCTIONS!
            ...
            function startUser(){
                ...
                //defaults
                $.fn.editable.defaults.url = 'updateIssueDetails.jspa';
                ...
                loadScript('<s:url value="/js/core/issues/editCard.js" />', function() {
                    editCard.initialize();
                });
                ...
                function initEditable($container, data, callback) {
                    ...
                    select2Setting = $.extend(select2Setting, //@TODO  状态值需要抽离
                                              callback === undefined ? {} : {display: callback}, status === 'VALIDATED' || status === 'CLOSED' ? {disabled: true} : {},
                                              ...
                                              }}:{}, $container.data("name") === "securityLevel" ? {url: "updateSecurityLevel.jspa"}:{});
                ...
                function initSelect2Component() {
                    ...
                    $("a[data-type='select2'], a[data-type='text'],a[data-type='textarea']:not([single]), a[data-type='combodate']").each(function(i, $obj) {
                        // 如果不想作为ediatble元素，可以为<a> 添加一个single属性
                        var tempStorage = [];
                        // 内联文本处理
                        if(typeof dataSource[$(this).data("name")] === "undefined") {
                            var select2Setting = {
                                disabled: false,
                                params: function(params) {
                                    var prefix = "issueDTO.", customParams = {};
                                ...
                                callback: function() {
                                    ...
                                    var html = '<li class="message message-reply">'
                                            + '<img src="'+$.url_root + data.userLogoPath+'"style="width: 31px; height: 31px;">'
                                                + '<span class="message-text break-all"> <a href="javascript:;" class="username">' + data.creator + '</a>' + data.commentBody + '</span>'
                                                + '<ul class="list-inline font-xs">'
                                                    + '<li>'
                                                        + '<a href="javascript:;" class="text-muted">' + data.createTime + '</a>'
                                                    + '</li>'
                                                + '</ul>'
                                            + '</li>';
                        ...
                        success: function(data) {
                            checkResult(data, {
                                callback: function() {
                                    ...
                                    +   '<span class="message-text break-all">'
                                    +   '<a href="javascript:;" class="username">' + data.creator + '</a>'
                                    +      data.commentBody
                                    +   '</span>'
                                    +   '<ul class="list-inline font-xs" style="margin-top: 5px;">'
                                    +      '<li><a href="javascript:;" class="text-danger action-delete" data-comment="' + data.issueCommentId + '">'+ '删除</a></li>'
                                    +   '</ul>'
                                    + '</li>'
