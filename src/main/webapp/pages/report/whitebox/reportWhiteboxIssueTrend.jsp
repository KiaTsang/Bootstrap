                        ...
                        <div>
                            ...
                            <div class="widget-body no-padding">
                                ...
                                <div id="report_content_A" class="padding-10" style="">
                                        ...
                                        <div  class="col-sm-12">
                                            <div class="widget-body-toolbar bg-color-white" id="rev-toggles_A">
                                                <div class="btn-group hidden-phone pull-right">
                                                    <a href="javascript:void(0);" class="btn btn-xs btn-default exportExcel"><i class="fa fa-cog"></i> <s:text name="report.export"/> </a>
                                                </div>
                                            </div>
                                    ...
                                    <div class="row">
                                        <div  class="col-sm-12">
                                            <div class="widget-body-toolbar bg-color-white"></div>
...
<script type="text/javascript">
    ...
    function loadReportUserIssue() {
        loadScript("<s:url value='/js/core/report/whitebox/reportWhiteboxIssueTrend.js'/>", init);
    }
    function init() {
    	WhiteboxIssueTrend.initEvent();
    	WhiteboxIssueTrend.stat(); //初始化	
    }
