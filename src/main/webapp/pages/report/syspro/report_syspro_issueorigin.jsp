                    ...
                    <div class="widget-body no-padding">
                        ...
                        <div class="padding-10">
                            ...
                            <div class="row hidden" id="pieRow">
                                <hr />
                                <div class="col-sm-6">
                                    <p class="text-center"><span></span>缺陷来源分布情况</p>
                                    <div id="pie_chart1" class="chart-large" style="height: 300px;"></div>
                                </div>
                                <div class="col-sm-6">
                                    <p class="text-center"><span></span>历史缺陷来源分布情况</p>
...
<script type="text/javascript">
    ...
    function loadReportIssueOrigin() {
        loadScript("<s:url value='/js/core/report/system/reportIssueOrigin.js'/>", init);
    }
    function init() {
        ReportOrigin.init(); //初始化
    }
