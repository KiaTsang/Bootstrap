    ...
    <div id="main" role="main">
        ...
        <div id="ribbon">
            ...
            <ol class="breadcrumb">
                ...
                <li><s:text name="report.cardProType"/></li>
            </ol>
            <!-- end breadcrumb -->
        </div>
        <!-- END RIBBON -->
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="pull-right">
                                                    <h1 class="font-400"><s:text name="report.byCardProType"/></h1>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div  class="col-sm-12">
                                                ...
                                                <div class="padding-10">
                                                    <div id="pie_chart_C" class="chart-large" style="width: 100%;height: 350px;"></div>
                                                </div>
                                            </div>
                                        </div>
...
<script type="text/javascript">
    ...
    function loadCardProductTypeJS(){
    	loadScript("<s:url value='/js/core/report/card/reportCardProductType.js'/>", init);
    }
    
    function init() {
        CardProductType.initializeComponent();
    }
</script>
</html>
