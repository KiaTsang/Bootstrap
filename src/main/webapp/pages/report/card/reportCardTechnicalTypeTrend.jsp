                    ...
                    <div class="jarviswidget well jarviswidget-color-darken" id="wid-id-0" data-widget-sortable="false" data-widget-deletebutton="false" data-widget-editbutton="false" data-widget-colorbutton="false">
                        ...
                        <div>
                            ...
                            <div class="widget-body no-padding">
                                ...
                                <div id="report_content_D" class="padding-10" style="">
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        <div  class="col-sm-12">
                                            <div class="widget-body-toolbar bg-color-white" id="rev-toggles_D">
                                            ...
                                            <div class="padding-10">
                                                <div id="flotcontainer_D" class="chart-large has-legend-unique"></div>
                                            </div>
                                        </div>
                                    </div>
...
<script type="text/javascript">
    ...
    function loadReportUserIssue() {
        loadScript("<s:url value='/js/core/report/card/reportCardTechnicalTypeTrend.js'/>", init);
    }
    function init() {
    	TechnicalTypeTrend.initEvent();
    	TechnicalTypeTrend.stat(); //初始化	
    }
