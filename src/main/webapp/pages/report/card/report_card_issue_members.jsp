                        ...
                        <div class="jarviswidget well jarviswidget-color-darken" id="wid-id-0" data-widget-sortable="false" data-widget-deletebutton="false" data-widget-editbutton="false" data-widget-colorbutton="false">
                            ...
                            <div>
                                ...
                                <div class="widget-body no-padding">
                                        ...
                                        <div id="subType_content_A" class="row" style="margin-top: 10px;">
                                            <div class="col-sm-12">
                                                <div class="well" style="">
                                                    <span>请选择需要统计的人员 :&nbsp &nbsp</span>
                                                    <span>
                                    ...
                                    <div id="report_content_A" class="padding-10 hidden" style="">
                                        <div class="row">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-5">
                                                    <div class="invoice-sum-total pull-right">
                                                        <h3><strong>总数量: <span class="text-success totalQuantity"></span></strong></h3>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
...
<script type="text/javascript">
    ...
    function generatePageGraphs(){
    	loadScript("<s:url value='/js/core/report/card/reportCardIssueMember.js'/>", init);
    }

    function init(){
    	CardReportMembers.initializeComponent();
    }
</script>
</html>
