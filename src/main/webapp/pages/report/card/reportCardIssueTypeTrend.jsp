                    ...
                    <div class="jarviswidget well jarviswidget-color-darken" id="wid-id-0" data-widget-sortable="false" data-widget-deletebutton="false" data-widget-editbutton="false" data-widget-colorbutton="false">
                        ...
                        <div>
                            ...
                            <div class="widget-body no-padding">
                                ...
                                <div id="report_content_B" class="padding-10" style="">
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        <div  class="col-sm-12">
                                            <div class="widget-body-toolbar bg-color-white" id="rev-toggles_B">
...
<script type="text/javascript">
    ...
    function loadReportUserIssue() {
        loadScript("<s:url value='/js/core/report/card/reportCardIssueTypeTrend.js'/>", init);
    }
    function init() {
    	IssueTypeTrend.initEvent();
    	IssueTypeTrend.stat(); //初始化	
    }
