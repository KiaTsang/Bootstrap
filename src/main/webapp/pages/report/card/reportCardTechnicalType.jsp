                        ...
                        <div class="padding-10">
                            ...
                            <div class="row">
                                <div  class="col-sm-12">
                                    ...
                                    <div class="padding-10">
                                        <div id="flotcontainer" class="chart-large has-legend-unique " style="height: 375px;"></div>
                                    </div>
                                </div>
                            </div>
...
<script type="text/javascript">
    ...
    function loadReportIssueOrigin() {
        loadScript("<s:url value='/js/core/report/card/reportCardTechnicalType.js'/>", init);
    }
    function init() {
        ReportTechnicalType.init(); //初始化
    }
