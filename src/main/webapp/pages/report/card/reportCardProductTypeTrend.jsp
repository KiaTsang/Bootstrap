                                    ...
                                    <div class="row">
                                        <div  class="col-sm-12">
                                            ...
                                            <div class="padding-10">
                                                <div id="flotcontainer_C" class="chart-large has-legend-unique "></div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
...
<script type="text/javascript">
    ...
    function loadReportUserIssue() {
        loadScript("<s:url value='/js/core/report/card/reportCardProductTypeTrend.js'/>", init);
    }
    function init() {
    	ProductTypeTrend.initEvent();
    	ProductTypeTrend.stat(); //初始化	
    }
